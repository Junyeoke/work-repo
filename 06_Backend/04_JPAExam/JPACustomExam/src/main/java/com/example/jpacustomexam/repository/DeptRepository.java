...
//    todo: 3) 부서 테이블에서 부서명(dname)과 위치(loc)를 매개변수로 받아 조회하는 함수를 작성해보기
...
//    todo: 4) 부서테이블의 부서번호를 sum, avg, max, min 값을 출력하는 함수를 작성하기
//             단, nativeQuery = true 사용
//             , DTO 클래스에 저장(오라클 쿼리 : 인터페이스로 만듬)
    ...
    // todo: 5) SQL 기본 내장 함수를 사용하는 함수 작성
    //          단, nativeQuery = true 사용
