...
import ThemaLoadList from "./pages/shop/thema_load/ThemaLoadList";
import FileDbList from "./pages/advanced/FileDbList";
import CheckOut from "./pages/shop/payment/Checkout";
import { SuccessPage } from "./pages/shop/payment/Success";
import Fail from "./pages/shop/payment/Fail";
    ...
    <div className="App">
      ...
      <div id="content-wrapper">
        ...
        <Routes>
          ...
          {/* 결제 */}
          <Route path="/simple-cart/:spno/payment" element={<CheckOut/>}/>
          {/* 결제 성공 */}
