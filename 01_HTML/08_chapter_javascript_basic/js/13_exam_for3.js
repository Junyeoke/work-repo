// 1)
// for문 안에 if문으로 짝수체크해서 더하기
// 입력 없음
// 출력 : 1 ~ 100까지 합계구하는데 짝수의 합계를 구해서 출력하시오.
...
//     }
// }
// document.querySelector("#output").innerHTML = sum2;
...
for(let i=0; i<num.length; i++) {
    // 5의 배수 판단
    if( num[i] % 5 === 0) { // num배열의 값이 5의 배수이면
        // 출력
...
//         result2 += i
//     }
// }  document.querySelector("#output").innerHTML = result2;
...
//         result3 += i + " ";
//     }
// } document.querySelector("#output").innerHTML = result3