                                    ...
                                    <div className="container">
                                        <div className="row gx-5 align-items-center">
                                            ...
                                            <div className="col-lg-6">
                                                ...
                                                <a className="btn-main mb10" href="pricing-table-one.html">Order Your Game Server Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="padding60 sm-padding40 sm-p-2 jarallax position-relative">
                                ...
                                <img src="images/misc/avatar.webp" className="sm-hide position-absolute bottom-0 end-0 wow fadeIn"  alt=""/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="no-bottom">
                <div className="container">
                    <div className="row align-items-center gx-5">
                        <div className="col-lg-6">
                            <img src="images/misc/server.webp" className="img-fluid mb-sm-30 wow fadeIn" alt=""/>
                        </div>
                ...
                <div className="container z-1000">
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 text-lg-end">
                            <a className="btn-main mb-sm-30" href="games.html">View all games</a>
                        </div>
                    </div>
                    <div className="row g-4 sequence">
                        <div className="col-lg-3 col-md-6 gallery-item">
                            <div className="de-item wow">
                                ...
                                <img src="images/covers/1.webp" className="img-fluid " alt=""/>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-6 gallery-item">
                            <div className="de-item wow">
                                ...
                                <img src="images/covers/2.webp" className="img-fluid " alt=""/>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-6 gallery-item">
                            <div className="de-item wow">
                                ...
                                <img src="images/covers/3.webp" className="img-fluid " alt=""/>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-6 gallery-item">
                            <div className="de-item wow">
                                ...
                                <img src="images/covers/4.webp" className="img-fluid " alt=""/>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-6 gallery-item">
                            <div className="de-item wow">
                                ...
                                <img src="images/covers/5.webp" className="img-fluid " alt=""/>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-6 gallery-item">
                            <div className="de-item wow">
                                ...
                                <img src="images/covers/6.webp" className="img-fluid " alt=""/>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-6 gallery-item">
                            <div className="de-item wow">
                                ...
                                <img src="images/covers/7.webp" className="img-fluid " alt=""/>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-6 gallery-item sandbox">
                            <div className="de-item wow">
                                ...
                                <img src="images/covers/8.webp" className="img-fluid" alt=""/>
                            </div>
                        </div>
                            ...
                            <div className="padding60 sm-padding40 jarallax position-relative">
                                ...
                                <div className="row">
                                    <div className="col-lg-6">
                                        ...
                                        <a href="download.html"><img src="images/misc/download-appstore.webp" className="img-fluid mb-sm-20" alt="download"/></a>&nbsp;
                                        <a href="download.html"><img src="images/misc/download-playstore.webp" className="img-fluid mb-sm-20" alt="download"/></a>
                                    </div>
                                </div>

                                <img src="images/misc/man-with-phone.webp" className="sm-hide position-absolute bottom-0 end-0 wow fadeIn"  alt=""/>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6">
                            <div className="row g-4">
                                ...
                                <div className="col-sm-2 col-4">
                                    <div className="p-2 rounded-10" data-bgcolor="rgba(255, 255, 255, .05)">
                                        <img src="images/payments/mastercard.webp" className="img-fluid" alt=""/>
                                    </div>
                                </div>
                                <div className="col-sm-2 col-4">
                                    <div className="p-2 rounded-10" data-bgcolor="rgba(255, 255, 255, .05)">
                                ...
                                <div className="col-sm-2 col-4">
                                    <div className="p-2 rounded-10" data-bgcolor="rgba(255, 255, 255, .05)">
                                        <img src="images/payments/american-express.webp" className="img-fluid" alt=""/>
                                    </div>
                                </div>
                            </div>
                        </div>
