  ...
  return (
    <>
            ...
            <section id="subheader" className="jarallax">
                <img src={require('../../assets/images/background/subheader-affliate.webp')} className="jarallax-img" alt=""/>
                <div className="container z-1000">
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            <h2 className="wow fadeInUp mb20" data-wow-delay=".2s">Join our affiliate team and  Earn 10% commission</h2>
                        </div>                 
                    </div>
                </div>
            </section>
            ...
            <section>
                <div className="container">
                    <div className="row row-flex">
                        ...
                        <div className="col-lg-4 mb30 wow fadeInRight" data-wow-delay=".4s">
                            <div className="de-step-s1">
                        ...
                        <div className="col-lg-4 mb30 wow fadeInRight" data-wow-delay=".6s">
                            <div className="de-step-s1">
                    ...
                    <div className="col-lg-12 text-center">
                        <a className="btn-main btn-lg wow zoomIn" href="#">Join Today</a>
                    </div>
                </div>
